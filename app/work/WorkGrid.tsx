...
import MobileWorkShowcase from "./MobileWorkShowcase";
...
export function WorkGrid() {
  const isSmall = useIsSmall(1023);

  // نسخه‌ی موبایل: داخل ارتفاع 360px بدون اسکرول عمودی
  if (isSmall) {
    return (
      <div className="w-full max-w-5xl mx-auto">
        <MobileWorkShowcase items={workItems} height={360} />
      </div>
    );
  }

  // نسخه‌ی دسکتاپ (ChromaGrid همانی که ساختی)
  return (
    <div className="w-full max-w-5xl mx-auto h-[380px]">
      <ChromaGrid
        items={workItems}
